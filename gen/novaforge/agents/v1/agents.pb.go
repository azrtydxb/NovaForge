...
const file_novaforge_agents_v1_agents_proto_rawDesc = "" +
	...
	"\x06intent\x18\x01 \x01(\v2\".novaforge.identity.v1.GrantIntentR\x06intent2\xde\b\n" +
	"\fAgentService\x12i\n" +
...
var file_novaforge_agents_v1_agents_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_novaforge_agents_v1_agents_proto_goTypes = []any{
	...
	(*v1.GrantIntent)(nil),              // 27: novaforge.identity.v1.GrantIntent
}
var file_novaforge_agents_v1_agents_proto_depIdxs = []int32{
	...
	27, // 9: novaforge.agents.v1.GetGrantIntentResponse.intent:type_name -> novaforge.identity.v1.GrantIntent
	25, // 10: novaforge.agents.v1.AgentService.GetGrantIntent:input_type -> novaforge.agents.v1.GetGrantIntentRequest
	1,  // 11: novaforge.agents.v1.AgentService.CreateAgent:input_type -> novaforge.agents.v1.CreateAgentRequest
	3,  // 12: novaforge.agents.v1.AgentService.ListAgents:input_type -> novaforge.agents.v1.ListAgentsRequest
	6,  // 13: novaforge.agents.v1.AgentService.StartRun:input_type -> novaforge.agents.v1.StartRunRequest
	8,  // 14: novaforge.agents.v1.AgentService.GetRun:input_type -> novaforge.agents.v1.GetRunRequest
	10, // 15: novaforge.agents.v1.AgentService.CancelRun:input_type -> novaforge.agents.v1.CancelRunRequest
	12, // 16: novaforge.agents.v1.AgentService.StreamRunEvents:input_type -> novaforge.agents.v1.StreamRunEventsRequest
	17, // 17: novaforge.agents.v1.AgentService.ListStats:input_type -> novaforge.agents.v1.ListStatsRequest
	19, // 18: novaforge.agents.v1.AgentService.ListToolCalls:input_type -> novaforge.agents.v1.ListToolCallsRequest
	21, // 19: novaforge.agents.v1.AgentService.ListRunsForWorkItem:input_type -> novaforge.agents.v1.ListRunsForWorkItemRequest
	23, // 20: novaforge.agents.v1.AgentService.CheckBranchLock:input_type -> novaforge.agents.v1.CheckBranchLockRequest
	26, // 21: novaforge.agents.v1.AgentService.GetGrantIntent:output_type -> novaforge.agents.v1.GetGrantIntentResponse
	2,  // 22: novaforge.agents.v1.AgentService.CreateAgent:output_type -> novaforge.agents.v1.CreateAgentResponse
	4,  // 23: novaforge.agents.v1.AgentService.ListAgents:output_type -> novaforge.agents.v1.ListAgentsResponse
	7,  // 24: novaforge.agents.v1.AgentService.StartRun:output_type -> novaforge.agents.v1.StartRunResponse
	9,  // 25: novaforge.agents.v1.AgentService.GetRun:output_type -> novaforge.agents.v1.GetRunResponse
	11, // 26: novaforge.agents.v1.AgentService.CancelRun:output_type -> novaforge.agents.v1.CancelRunResponse
	13, // 27: novaforge.agents.v1.AgentService.StreamRunEvents:output_type -> novaforge.agents.v1.StreamRunEventsResponse
	18, // 28: novaforge.agents.v1.AgentService.ListStats:output_type -> novaforge.agents.v1.ListStatsResponse
	20, // 29: novaforge.agents.v1.AgentService.ListToolCalls:output_type -> novaforge.agents.v1.ListToolCallsResponse
	22, // 30: novaforge.agents.v1.AgentService.ListRunsForWorkItem:output_type -> novaforge.agents.v1.ListRunsForWorkItemResponse
	24, // 31: novaforge.agents.v1.AgentService.CheckBranchLock:output_type -> novaforge.agents.v1.CheckBranchLockResponse
