...
const (
	AgentService_GetLegacyGrantBinding_FullMethodName = "/novaforge.agents.v1.AgentService/GetLegacyGrantBinding"
...
type AgentServiceClient interface {
	GetLegacyGrantBinding(ctx context.Context, in *GetLegacyGrantBindingRequest, opts ...grpc.CallOption) (*GetLegacyGrantBindingResponse, error)
...
func (c *agentServiceClient) GetLegacyGrantBinding(ctx context.Context, in *GetLegacyGrantBindingRequest, opts ...grpc.CallOption) (*GetLegacyGrantBindingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetLegacyGrantBindingResponse)
	err := c.cc.Invoke(ctx, AgentService_GetLegacyGrantBinding_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AgentServiceServer interface {
	GetLegacyGrantBinding(context.Context, *GetLegacyGrantBindingRequest) (*GetLegacyGrantBindingResponse, error)
...
func (UnimplementedAgentServiceServer) GetLegacyGrantBinding(context.Context, *GetLegacyGrantBindingRequest) (*GetLegacyGrantBindingResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLegacyGrantBinding not implemented")
}
...
func _AgentService_GetLegacyGrantBinding_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetLegacyGrantBindingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentServiceServer).GetLegacyGrantBinding(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AgentService_GetLegacyGrantBinding_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServiceServer).GetLegacyGrantBinding(ctx, req.(*GetLegacyGrantBindingRequest))
	}
...
var AgentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetLegacyGrantBinding",
			Handler:    _AgentService_GetLegacyGrantBinding_Handler,
		},
		{
