...
// numbers. Allocation bytes give deterministic evidence even on a busy host.
func seedBenchmarkHistory(t *testing.T, store *ci.Store, arts *ci.ArtifactStore, blobs *blobstore.Client, org, repo uuid.UUID) {
	t.Helper()
