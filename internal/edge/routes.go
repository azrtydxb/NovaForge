...
func Routes() []Route {
	return []Route{
		...
		{http.MethodPatch, "/api/v1/orgs/{org}/repos/{repo}/work/{key}", "patchWorkItem", "Edit open Work Item intent with expected values"},
		{http.MethodPost, "/api/v1/orgs/{org}/repos/{repo}/work/{key}/transitions", "transitionWorkItem", "Block or reopen eligible human work"},
		...
		{http.MethodGet, "/api/v1/orgs/{org}/agent-runs/{id}/tools", "getAgentRunTools", "Persisted observable Agent Run tool calls"},
		{http.MethodGet, "/api/v1/orgs/{org}/agent-runs/{id}/events", "streamAgentRunEvents", "Authenticated Agent Run tool events (SSE with durable cursor-based replay)"},
		...
		{http.MethodPost, "/api/v1/orgs/{org}/engineering-runs/{run_id}/agent-reviews", "requestAgentReview", "Queue an independent agent review of the inspected revision"},
		{http.MethodGet, "/api/v1/orgs/{org}/engineering-runs/{run_id}/agent-reviews", "listAgentReviewRequests", "Durable independent review requests and role outcomes"},
		{http.MethodGet, "/api/v1/orgs/{org}/engineering-runs/{run_id}/reviews", "listEngineeringRunReviews", "Durable review history by canonical run identity"},
		{http.MethodGet, "/api/v1/orgs/{org}/repos/{repo}/runs/{number}/reviews", "listRunReviews", "Revision-bound independent reviews"},
